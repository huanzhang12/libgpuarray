...
static char CL_PREAMBLE[] =
  ...
  "#define acosf(a) acos((float)(a))\n"
  "#define acoshf(a) acosh((float)(a))\n"
  "#define asinf(a) asin((float)(a))\n"
  "#define asinhf(a) asinh((float)(a))\n"
  "#define atanf(a) atan((float)(a))\n"
  "#define atanhf(a) atanh((float)(a))\n"
  "#define cbrtf(a) cbrt((float)(a))\n"
  "#define ceilf(a) ceil((float)(a))\n"
  "#define cosf(a) cos((float)(a))\n"
  "#define coshf(a) cosh((float)(a))\n"
  "#define cospif(a) cospi((float)(a))\n"
  "#define erfcf(a) erfc((float)(a))\n"
  "#define erff(a) erf((float)(a))\n"
  "#define expf(a) exp((float)(a))\n"
  "#define exp2f(a) exp2((float)(a))\n"
  "#define exp10f(a) exp10((float)(a))\n"
  "#define expm1f(a) expm1((float)(a))\n"
  "#define fabsf(a) fabs((float)(a))\n"
  "#define floorf(a) floor((float)(a))\n"
  "#define ilogbf(a) ilogb((float)(a))\n"
  "#define logf(a) log((float)(a))\n"
  "#define log2f(a) log2((float)(a))\n"
  "#define log10f(a) log10((float)(a))\n"
  "#define log1pf(a) log1p((float)(a))\n"
  "#define logbf(a) logb((float)(a))\n"
  "#define lgammaf(a) lgamma((float)(a))\n"
  "#define roundf(a) round((float)(a))\n"
  "#define rsqrtf(a) rsqrt((float)(a))\n"
  "#define sinf(a) sin((float)(a))\n"
  "#define sinhf(a) sinh((float)(a))\n"
  "#define sinpif(a) sinpi((float)(a))\n"
  "#define sqrtf(a) sqrt((float)(a))\n"
  "#define tanf(a) tan((float)(a))\n"
  "#define tanhf(a) tanh((float)(a))\n"
  "#define tanpif(a) tanpi((float)(a))\n"
  "#define tgammaf(a) tgamma((float)(a))\n"
  "#define truncf(a) trunc((float)(a))\n"
  "#define atan2f(a, b) atan2((float)(a), (float)(b))\n"
  "#define fdimf(a, b) fdim((float)(a), (float)(b))\n"
  "#define fmaxf(a, b) fmax((float)(a), (float)(b))\n"
  "#define fminf(a, b) fmin((float)(a), (float)(b))\n"
  "#define fmodf(a, b) fmod((float)(a), (float)(b))\n"
  "#define hypotf(a, b) hypot((float)(a), (float)(b))\n"
  "#define nextafterf(a, b) nextafter((float)(a), (float)(b))\n"
  "#define powf(a, b) pow((float)(a), (float)(b))\n"
  "#define remainderf(a, b) remainder((float)(a), (float)(b))\n"
  "#define fmaf(a, b, c) fma((float)(a), (float)(b), (float)(c))\n"
  "#define ldexpf(a, b) ldexp((float)(a), (b))\n"
  "#define modff(a, b) modf((float)(a), (__global float*)(b))\n"
  "#define remquof(a, b, c) remquof((float)(a), (float)(b), (c))\n"
  "#define sincosf(a, b, c) *((__global float*)(b)) = sincos((float)(a), (__global float*)(c))\n"
